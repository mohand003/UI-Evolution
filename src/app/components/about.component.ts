...
@Component({
  ...
  <section class="hero-section text-center py-5 bg-light bg-body-secondary">
    <div class="container up">
      ...
      <video style="text-align: center; width: 900px; height: 700px;" controls>
      <source src="assets/invideo-ai-1080 Revolutionizing UI Design with AI_ The F 2025-02-18.mp4" type="video/mp4">
      </video>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-md-6 width: 400px; height: 300px;">
          <img src="../../assets/Mission1.png" alt="Mission Image" class="img-fluid rounded">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="vision-section py-5 bg-body-secondary">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-6 width: 400px; height: 300px;">
          <img src="../../assets/Vision1.png" alt="Vision Image" class="img-fluid rounded">
        </div>
        <div class="col-md-6">
